...
// Función para calcular el promedio de un equipo
function promedioEquipo(equipo) {
  let total = 0;
  for (let i = 0; i < equipo.length; i++) {
    total += parseFloat(equipo[i].promedioJugador); 
  }
...
const equipo1 = crearEquipo(playersList, jugadoresPorEquipo, "Equipo 1");
...
const equipo2 = crearEquipo(playersList, jugadoresPorEquipo, "Equipo 2");

// Calcula el promedio del equipo 1 pasando el array de jugadores de equipo1
const promedioEquipo1 = promedioEquipo(equipo1);
console.log("El promedio del equipo 1 es: ", promedioEquipo1);

// Calcula el promedio del equipo 2 pasando el array de jugadores de equipo2
const promedioEquipo2 = promedioEquipo(equipo2);
console.log("El promedio del equipo 2 es: ", promedioEquipo2);
